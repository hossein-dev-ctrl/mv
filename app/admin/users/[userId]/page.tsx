...
export default async function UserPage({params}:{params:Promise<{userId:string}>}) {
 ...
 return <main className="mx-auto max-w-5xl px-4 py-8"><Link href="/admin/users" className="panel-action panel-action-indigo">بازگشت به کاربران</Link><h1 className="my-5 text-2xl font-bold">{user.name||'کاربر بدون نام'}{user.demoBatchId&&' — حساب آزمایشی'}</h1>
