...
export async function POST(request:Request,{params}:{params:Promise<{courseId:string}>}){
 ...
 await prisma.courseInterest.upsert({where:{courseId_userId:{courseId,userId:user.id}},create:{courseId,userId:user.id,name:body.data.name,phone:body.data.phone},update:{}});
